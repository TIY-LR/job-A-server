namespace JobHunt.Migrations
{
    ...
    public partial class Contact_company_lead_initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Leads", "User_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Leads", "Contact_Id", "dbo.Contacts");
            ...
            DropIndex("dbo.Leads", new[] { "Contact_Id" });
